var systemComponents = {
	...
	'options-tab': {
        ...
        <table>
            <tr>
                <td><button class="opt" onclick="save()">手动保存</button></td>
            ...
            <tr>
                <td><button class="opt" onclick="exportSaveToFile()">导出到文件</button></td>
                <td><button class="opt" onclick="importSaveFromFile()">从文件导入</button></td>
                ...
                <td><button class="opt" onclick="adjustMSDisp()">显示里程碑: {{ MS_DISPLAYS_ZH[MS_SETTINGS.indexOf(options.msDisplay)]}}</button></td>
            </tr>
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('forceOneTab'); needsCanvasUpdate = true">单一界面模式: {{ options.forceOneTab?"总是":"自动" }}</button></td>
				<td><button class="opt" onclick="toggleOpt('forceTooltips'); needsCanvasUpdate = true">Shift单击切换文本浮窗显示: {{ options.forceTooltips?"开":"关" }}</button></td>
				<td><button class="opt" onclick="changeNotation()">记数法: {{ notationsZH[notations.indexOf(player.notation)] }}</button></td>
            </tr>
			<tr>
				<td><button class="opt" onclick="changeEndgameShown()">显示版本终点 (剧透): {{ options.endgameShown?"开":"关" }}</button></td>
				<td><button class="opt" onclick="changeMaximumOoMsInCommas()">最大按逗号显示的数量级 (不是所有记数法都生效): {{ formatWhole(options.maximumOoMsInCommas) }} </button></td>
			</tr>
